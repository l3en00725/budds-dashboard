-- Create line items table for accurate membership tracking
...
GRANT ALL ON jobber_line_items TO authenticated;
GRANT ALL ON jobber_line_items TO anon;
GRANT ALL ON jobber_line_items TO service_role;